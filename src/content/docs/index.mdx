...
hero:
  ...
  tagline: "Two products for engineering teams — a $0 local index and ADR-level guardrails that run in CI."
  image:
    dark: ../../assets/logo-dark.svg
    light: ../../assets/logo-light.svg
  actions:
    - text: Build your index
      link: /docs/getting-started/
      icon: right-arrow
      variant: primary
    - text: Enforce your ADRs
      link: /docs/cari/semantic-rules/
...
<CardGrid>
  <Card title="CARI Evidence Engine — always $0" icon="seti:db">
    ...
    visualization, community detection, clone detection, and more — in under 3 seconds.
    **The foundation. Always free. Always local.**
  </Card>
  <Card title="Intent Engine" icon="approve-check-circle">
    Turn your ADRs and conventions into executable rules that run in CI. Catch
    property-access violations, forbidden call patterns, architecture drift, and
    documentation staleness — all at $0 after a one-time LLM extraction step.
  </Card>
</CardGrid>
...
The Insights Book shows your architecture, violations grouped by domain, and a

...
<CardGrid>
  ...
  <Card title="API Surface Tracking" icon="list-format">
    Track exported symbols across releases. Detect additions, removals, and
    signature changes automatically from git history — no manual changelog
    maintenance.
  </Card>

...
<CardGrid>
  ...
  <Card title="Layer 3: Intent Verification" icon="approve-check-circle">
    The apex — weave code graph and intent graph together. Verify that specs
    match implementation, track decisions through their lifecycle, and score
    your documentation as a living system. **Coming soon.**
  </Card>
</CardGrid>
